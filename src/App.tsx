        ...
        <AuthProvider>
          <Layout>
            <Routes>
              ...
              <Route path="/pipeline" element={<div className="p-6"><h1 className="text-3xl font-bold">Suivi du Pipeline</h1><p className="text-gray-600 mt-2">Vue Kanban des opportunités - En développement</p></div>} />
